  ...
  <div class="alpha">
    ...
    <div class="section-alpha">
      ...
      <div class="section-1">
        ...
        <div class="text-part">
          <p class="text-2">Commercial Law</p>
          <p class="text-1">Clear and Concise Advice</p>
...
/*}*/
.alpha{
  background-image: url("https://www.halelegal.com.au/application/files/cache/thumbnails/625ca3984bdc7ed90dca5a3f1e78b21f.jpg");
