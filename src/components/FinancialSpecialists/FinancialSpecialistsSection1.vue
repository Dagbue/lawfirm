  ...
  <div class="alpha">
    ...
    <div class="section-alpha">
      ...
      <div class="section-1">
        ...
        <div class="text-part">
          <p class="text-2">Alderwood & Financial Law Group</p>
          <p class="text-1">Financial Specialists</p>
          <p class="text-3">Book an Appointment</p>
...
<script>
export default {
  name: "FinancialSpecialistsSection1",
  methods: {
    onPostClick() {
...
/*}*/
.alpha{
  background-image: url("https://images.unsplash.com/photo-1444653614773-995cb1ef9efa?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8RmluYW5jaWFsJTIwU3BlY2lhbGlzdHN8ZW58MHx8MHx8fDA%3D");
