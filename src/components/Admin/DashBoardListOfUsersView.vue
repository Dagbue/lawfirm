  ...
  <div class="alpha">
    <div class="body">
      ...
      <div class="row trans-mgt">
        ...
        <div class="form-group fg--search">
          ...
          <input  type="text" class="input" placeholder="Search User Requests..." v-model="searchQuery" @input="filterUsers"/>
        </div>
    ...
    <div class="section-5">
      ...
      <div class="empty-state" v-if="this.history.length === 0" >
        ...
        <p class="empty-state-text-2">This is where your user request will appear</p>
...
export default {
  ...
  async created() {
    ...
    try {
      const querySnapshot2 = await getDocs(collection(db, "RequestBody"));
