    ...
    <div class="section-alpha">
      ...
      <div class="section-1">
        ...
        <div class="text-part">
          ...
          <p class="text-1">Alternative Dispute Resolution</p>
          <p class="text-3" @click="onPostClick">Book an Appointment</p>
...
<script>
export default {
  name: "DisputeResolutionSection1",
  methods: {
    onPostClick() {
...
/*}*/
.alpha{
  background-image: url("https://www.halelegal.com.au/application/files/cache/thumbnails/25d6ff7850ebb8c140ff1a18b4d383a8.jpg");
